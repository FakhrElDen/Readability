...
@section('header')
    ...
    <div class="contentWrapper__right__heading">
        <h1 class="color-black cap-case">Add Hotels</h1>
    </div>
    <div class="contentWrapper__right__ctrls text-right">
        <ul class="list-unstyled list-inline">
            <li>
                <a href="{{ route('hotels') }}" class="cap-case color-black">Hotels</a>
            </li>
            <li>
                <a href="{{ route('createHotel') }}" class="cap-case color-blue" style="font-family: 'openSemiBold', sans-serif;font-size: 15px;margin-left: 10px;">add Hotel</a>
            </li>
        </ul>
    </div>
...
@section('content')
    <div class="contentWrapper__content"><!--Start contentWrapper__content-->
        <div class="contentWrapper__content__form">
            ...
            <form enctype="multipart/form-data" action="{{env('APP_URL')}}/store-hotel" method="POST">
                {{ @csrf_field() }}
